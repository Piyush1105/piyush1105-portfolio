...
jQuery(document).ready(function ($) {
  ...
  var filterList = {
    ...
    hoverEffect: function hoverEffect() {// Simple parallax effect
  ...
  $('#contactform').submit(function () {
    $.ajax({
      ...
      success: function success(msg) {
        ...
        if (msg == 'success') {
          response = '<div class="alert alert-success success-send">' + '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' + '<i class="glyphicon glyphicon-ok" style="margin-right: 5px;"></i> ' + $success + '</div>';
          $(".name-contact").val('');
          $(".email-contact").val('');
          $(".subject-contact").val('');
          $(".message-contact").val('');
          ...
          response = '<div class="alert alert-danger error-send">' + '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' + '<i class="glyphicon glyphicon-remove" style="margin-right: 5px;"></i> ' + output_error + '</div>';
        } // Hide any previous response text


        $(".error-send,.success-send").remove(); // Show response message
  ...
  function initializes() {
    var contentString = '<div id="gmaps">' + '<img src="https://demo.flexy-codes.com/flexyblog/images/writers/staff-1.jpg" alt="" /><br />' + '<p style="font-family: Arial, Helvetica, sans-serif;">Yadav City, Garhi bolni road.<br /><br />Phone: +91 9996079146</p>' + '</div>';
    var infowindow = new google.maps.InfoWindow({
      content: contentString
    });
    var mapOptions = {
      zoom: 14,
      center: new google.maps.LatLng(28.166396, 76.629992),
      mapTypeId: google.maps.MapTypeId.ROADMAP
    };
    var map = new google.maps.Map(document.getElementById("map_canvas"), mapOptions);
    var marker = new google.maps.Marker({
      position: new google.maps.LatLng(28.166396, 76.629992),
      map: map,
      title: 'Yadav City, Grahi bolni road.',
